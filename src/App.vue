...
<template>
  ...
  <ul class="absolute left-1/2 transform -translate-x-1/2 flex gap-6">
    ...
    <template v-if="user.id !== null">
      <!-- <li>
        <RouterLink to="/chat" class="hover:text-[#00FFC3] transition-all hover:scale-110">Muro</RouterLink>
      </li> -->
      <li>
        <RouterLink
            v-if="user.is_admin"
    ...
    <template v-else>
      <li>
        <RouterLink to="/ingresar" class="hover:text-[#00FFC3] transition-all hover:scale-110">Ingresar</RouterLink>
      </li>
      <!-- <li>
        <RouterLink to="/crear-cuenta" class="hover:text-[#00FFC3] transition-all hover:scale-110">Crear cuenta</RouterLink>
      </li> -->
    </template>
  </ul>

  <!-- Placeholder para balancear el nav -->
  <div class="w-1/3"></div>
</nav>
